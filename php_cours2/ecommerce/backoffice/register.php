...
if(!empty($_POST));{
    ...
    if(!empty($_POST['firstname']) && !empty($_POST['lastname']) && !empty($_POST['email']) && !empty($_POST['password'])){
        ...
        if ($_POST['password'] == $_POST['r_password'] && strlen($_POST['password']) >= 8){
            ...
            // mysqli_query() est une fonction qui permet à l'aide de la variable $db_connect et de la requete SQL 
            // précédente , d'exécuter la requete SQL (select\insert\update ou delete)

            if(mysqli_num_rows($tableUser)== 0 && filter_var($email, FILTER_VALIDATE_EMAIL)){
            // Si il y'a 0 correspondance ALORS l'email est donc bien vierge et peut etre creer 
            // Sinon l'email est deja existant
            ...
            // header('Location: login.php');
                ...
                echo "ERREUR MAIL DEJA UTILISER" ; 
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Repeat Password" name="r_password">
                                    </div>
                                </div>
